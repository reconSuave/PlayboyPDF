...
bondi_dll = os.path.join(str(cwd), str("BondiReader.DJVU.dll"))
...
def main():
    parser = argparse.ArgumentParser(
        description="Process 'Playboy: Cover to Cover' (Bondi) DJVU files or directories of DJVU files. Github: https://github.com/reconSuave/PlayboyPDF"
    )
    parser.add_argument("path", help="The DJVU file or directory to process.")
    parser.add_argument(
        "--output_dir",
        default=os.path.join(os.getcwd(), "output"),
        help="Directory to save the processed PDFs.",
    )
